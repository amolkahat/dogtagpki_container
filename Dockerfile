...
RUN pip3 install linchpin lxml pyopenssl ansible==2.7.1 pytest-ansible==2.0.2 client pytest-ansible-playbook==0.4.1 pytest-logger pytest-autochecklog==0.2.0 configparser pytest-html
